    ...
    >
      ...
      <div className="flex items-center justify-between mt-4">
        <div className="flex-1">
          <Button
            className={`w-[200px] h-10 text-sm font-semibold rounded-2xl transition-all shadow-sm ${applied ? "bg-muted text-muted-foreground" : "bg-primary text-primary-foreground hover:bg-primary/90"
              }`}
            onClick={(e) => {
              e.preventDefault();
              e.stopPropagation();
        ...
        <div className="flex items-center gap-3 ml-4">
          ...
          <button
            ...
            className="p-2 rounded-full hover:bg-muted transition-colors flex-shrink-0 border border-transparent hover:border-border shadow-sm"
          >
            <Heart
              size={23}
