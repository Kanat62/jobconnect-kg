    ...
    <div className="flex flex-col h-screen bg-background">
      ...
      <header className="flex items-center gap-3 px-4 py-3 border-b border-border bg-background">
        ...
        <div className="flex-1 min-w-0">
          <p className="font-semibold text-sm text-foreground truncate">{chat.company}</p>
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-3">
        ...
        <div className="bg-primary-light rounded-2xl p-3 mx-auto max-w-xs text-center text-sm">
          <p className="text-xs text-muted-foreground">Вакансия</p>
          <p className="font-semibold text-primary">{chat.jobTitle}</p>
      ...
      <div className="p-4 border-t border-border bg-background">
        <div className="flex gap-2 items-center">
          ...
          <button
            ...
            className="p-2.5 rounded-xl bg-primary text-primary-foreground disabled:opacity-50 transition-colors"
          >
            <Send size={18} />
          </button>
        </div>
