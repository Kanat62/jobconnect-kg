...
import { Building2, Briefcase, CreditCard, Receipt, ChevronRight, LogOut, FileQuestion, Globe, Bell } from "lucide-react";
      ...
      <div className="px-4 lg:px-6 py-4 lg:py-6 max-w-2xl mx-auto">
        ...
        <div className="space-y-1 mb-6">
          {[
            ...
            <Link key={item.path} to={item.path} className="flex items-center gap-3 p-3 rounded-xl hover:bg-muted transition-colors">
